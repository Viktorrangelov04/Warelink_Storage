...
export default function ReceivedOrders() {
  ...
  useEffect(() => {
    ...
    const ordersRef = collection(db, "stores", storeId, "receivedOrders");
  ...
  return (
    <>
      {orders.length === 0 ? (
        <Typography variant="h6" color="green" sx={{ width: "100%", mt: 4 }}>
          ...
          {selectedOrder && (
            <>
              ...
              <Button
                ...
                sx={{ mt: 2 }}
                onClick={async () => {
                  await completeOrder(selectedOrder.id, storeId);
